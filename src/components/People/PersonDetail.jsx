...
const PersonDetail = () => {
  ...
  const totalDuaas = person.duaas_a.length;
  const completedDuaas = person.duaas_a.filter((duaa) => duaa.is_done).length;
